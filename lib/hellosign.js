 ...
 * @param {string} api_key    HelloSign API key.
 * @param {boolean} test_mode Make requests in test mode.
 */
var Account = function (api_key, test_mode) {
  this.api_key = api_key;
  this.test_mode = test_mode ? "1" : "0";
};
...
SignatureRequest.prototype.files = function (parameters) {
  if(!parameters.signature_request_id) {
    throw new HelloSignError("Missing required parameter signature_request_id");
  }
 ...
 * @param  {object} parameters  Object containing the request parameters.
 *                              See https://www.hellosign.com/api/reference#Embedded 
 * @return {Promise}            When.js promise that returns the response.
 */
